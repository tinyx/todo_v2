...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configureStore = __webpack_require__(1);
	...
	if (token !== null) {
	  store.dispatch((0, _authentication.loginUserSuccess)(token));
	} else {
	  store.dispatch((0, _authentication.loginUser)('jwttest', 'jwttest'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(initialState) {
	  ...
	  createStoreWithMiddleware = (0, _redux.compose)(middleware, window.devToolsExtension ? window.devToolsExtension() : function (f) {
	    return f;
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authentication = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _utils.createReducer)(initialState, (_createReducer = {}, _defineProperty(_createReducer, _authentication.LOGIN_USER_REQUEST, function (state, payload) {
	    return Object.assign({}, state, {
	        'isAuthenticating': true,
	        'statusText': null
	    });
	}), _defineProperty(_createReducer, _authentication.LOGIN_USER_SUCCESS, function (state, payload) {
	    return Object.assign({}, state, {
	        'isAuthenticating': false,
	        'isAuthenticated': true,
	        'token': payload.token,
	        'userName': (0, _jwtDecode2.default)(payload.token).userName,
	        'statusText': 'You have been successfully logged in.'
	    });
	}), _defineProperty(_createReducer, _authentication.LOGIN_USER_FAILURE, function (state, payload) {
	    return Object.assign({}, state, {
	        'isAuthenticating': false,
	        'isAuthenticated': false,
	        'token': null,
	...
	}), _defineProperty(_createReducer, _authentication.LOGOUT_USER, function (state, payload) {
	    return Object.assign({}, state, {
	        'isAuthenticated': false,
	        'token': null,
	        'userName': null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RECEIVE_PROTECTED_DATA = exports.FETCH_PROTECTED_DATA_REQUEST = exports.LOGOUT_USER = exports.LOGIN_USER_SUCCESS = exports.LOGIN_USER_FAILURE = exports.LOGIN_USER_REQUEST = undefined;
	...
	var FETCH_PROTECTED_DATA_REQUEST = exports.FETCH_PROTECTED_DATA_REQUEST = 'FETCH_PROTECTED_DATA_REQUEST';
	var RECEIVE_PROTECTED_DATA = exports.RECEIVE_PROTECTED_DATA = 'RECEIVE_PROTECTED_DATA';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveProtectedData = receiveProtectedData;
	exports.fetchProtectedDataRequest = fetchProtectedDataRequest;
	exports.fetchProtectedData = fetchProtectedData;
	...
	function loginUser(username, password) {
	    ...
	    return function (dispatch) {
	        ...
	        return fetch('http://localhost:8090/api-token-auth/', {
	            method: 'post',
	            credentials: 'include',
	            headers: {
	...
	function receiveProtectedData(data) {
	    return {
	        type: _authentication.RECEIVE_PROTECTED_DATA,
	        payload: {
	            data: data
	        }
	    };
	...
	function fetchProtectedDataRequest() {
	    return {
	        type: _authentication.FETCH_PROTECTED_DATA_REQUEST
	    };
	}
